...
subject.plot <- research.areas %>%
  ...
  xlab("Research Area") +
scale_y_continuous(expand = c(0, 0), limits = c(0, 200), breaks = seq(0, 200, by = 50));subject.plot

# Save the ggplot to a file (e.g., in PNG format)
ggsave("output/WOS_plots/subject_output.png", plot = subject.plot, width = 34, height = 20, dpi = 300)
