...
Figure2 <- plot_grid(scopus.year, WOS.year, labels = c('A', 'B'), label_size = 14);Figure2

ggsave(filename=paste0("output/manuscript_figures/years.plot.png"), plot=Figure2, dpi=300, width=20, height=5, units="in", limitsize = FALSE)
...
Figure4 <- plot_grid(scopus.subject, WOS.subject, labels = c('A', 'B'), label_size = 14);Figure4

ggsave(filename=paste0("output/manuscript_figures/subject.plot.png"), plot=Figure4, dpi=300, width=20, height=5, units="in", limitsize = FALSE)
